...
import { ServiceItem, FaqItem, FeatureItem } from './types';

export const RESERVATION_LOGS = [
  "서울 종로구 구의원 예비후보 상담 예약 완료",
  "춘천시장 예비후보 상담 예약 완료",
  "동해시의원 예비후보 상담 예약 중",
  "경기도 동두천시장 예비후보 상담 예약 중",
  "경기도 남양주시 시의원 예비후보 상담 예약 완료",
  "광주광역시 시의원 예비후보 상담 예약 중"
];

export const SERVICE_ITEMS: ServiceItem[] = [
  {
    title: "SNS 홍보팀 패키지",
    description: "단기간 내 유권자와의 접점을 넓혀 인지도를 올리고자 하는 캠프를 위한 실전형 홍보 솔루션입니다.",
    features: [
      "쇼츠·릴스 제작",
      "후보 심층 인터뷰 & 브랜딩",
      "정책 카드뉴스, 웹포스터",
...
export const FEATURES: FeatureItem[] = [
  ...
  },
  {
    ...
    title: "실전형 속도",
    description: "소스 투입 시 3~12시간 이내 콘텐츠화하여 골든타임을 놓치지 않습니다."
  },
  {
    icon: <ShieldCheck className="w-8 h-8 text-lime-400" />,
    title: "검증된 실무 전문성",
    description: "다년간 캠프 홍보 실무를 경험한 인력이 검증된 콘텐츠를 기획·제작합니다."
  }
];
